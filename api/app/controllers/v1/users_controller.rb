class V1::UsersController < ApplicationController
  ...
  def show
    ...
    render json: {
      ...
      posts: public_posts.as_json(methods: :image_url, except: :updated_at, include: { user: { methods: :image_url } }),
      doing_posts: doing_posts.as_json(methods: :image_url, include: { user: { methods: :image_url } }),
      want_posts: want_posts.as_json(methods: :image_url, include: { user: { methods: :image_url } }),
      master_posts: master_posts.as_json(include: { user: { methods: :image_url } }),
